...
def MobileNetV2(input_shape=None,
  ...
  if weights == 'imagenet':
    ...
    if rows != cols or rows not in [96, 128, 160, 192, 224]:
      if rows is None:
        rows = 224
        logging.warnings('MobileNet shape is undefined.'
  ...
  if K.image_data_format() != 'channels_last':
    logging.warnings('The MobileNet family of models is only available '
  ...
  x = BatchNormalization(momentum=0.999, name='bn_Conv1')(x)
...
def _inverted_res_block(
  ...
  if block_id:
    ...
    x = BatchNormalization(momentum=0.999, name=prefix + 'expand_BN')(x)
  ...
  x = BatchNormalization(momentum=0.999, name=prefix + 'depthwise_BN')(x)
  ...
  x = BatchNormalization(momentum=0.999, name=prefix + 'project_BN')(x)
